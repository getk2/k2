...
class K2ViewMedia extends K2View
{
    ...
    function display($tpl = null)
    {
        ...
        $document->addStyleSheet('//ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/smoothness/jquery-ui.css?v=2.7.2');
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/theme.css?v=2.7.2');
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/elfinder.min.css?v=2.7.2');
