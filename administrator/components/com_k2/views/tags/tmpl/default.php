	...
	<table class="adminlist table table-striped">
		<thead>
			<tr>
				...
				<th class="center<?php if($context == "modalselector") echo ' k2VisuallyHidden'; ?>"><input id="k2Toggler<?php echo $this->params->get('backendListToggler', 'TogglerStandard'); ?>" type="checkbox" name="toggle" value="" /></th>
