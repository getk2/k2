...
<?php if($app->isSite()): ?>
<!-- Frontend Item Editing -->
<div id="k2FrontendContainer">
	<div id="k2FrontendHeader">
		<h2 id="k2FrontendLogo"><?php echo JText::_('K2_USERS'); ?></h2>
...
<?php endif; ?>
	...
	<?php if($app->isAdmin() && $context == "modalselector"): ?>
	<h2 id="k2ModalSelectorHeader"><?php echo JText::_('K2_USERS'); ?></h2>
	<?php endif; ?>
			...
			<tbody>
				...
				<tr class="row<?php echo ($key%2); ?>">
					...
					<td>
						...
						<a class="k2ListItemDisabled" title="<?php echo JText::_('K2_CLICK_TO_ADD_THIS_ITEM'); ?>" onclick="window.parent.k2SelectUser('<?php echo $row->id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""), $row->name); ?>', 'id');"><?php echo $row->name; ?></a>
						<?php else: ?>
