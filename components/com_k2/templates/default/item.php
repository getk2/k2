	...
	<div class="itemSocialSharing">
		...
		<div class="itemFacebookButton">
			<div id="fb-root"></div>
                        ...
                        ?>
                        <script>(function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(d.getElementById(id)) return;js=d.createElement(s);js.id=id;js.src="<?php echo "//connect.facebook.net/{$langTag}/sdk.js#xfbml=1&version=v2.5"; ?>";fjs.parentNode.insertBefore(js,fjs);}(document,'script','facebook-jssdk'));</script>
