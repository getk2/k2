...
<div class="ucs-k2-item-view catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if ($this->item->params->get('pageclass_sfx')) echo ' ' . $this->item->params->get('pageclass_sfx'); ?>">
      ...
      <div class="catItemHeader">
        ...
        <?php if ($this->item->params->get('catItemCategory')) : ?>
          ...
          <div class="catItemCategory">
            <a href="<?php echo $this->item->category->link; ?>"><span class="badge bg-primary"><?php echo $this->item->category->name; ?></span></a>
          </div>
        <?php endif; ?>
      </div>
